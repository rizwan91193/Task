...
class DetailsAdapter : RecyclerView.Adapter<DetailsAdapter.DetailslistViewHolder>() {
    ...
    inner class DetailslistViewHolder(val viewDetailsListBinding: ViewDetailsListBinding) :
        RecyclerView.ViewHolder(viewDetailsListBinding.root) {

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailslistViewHolder =
        DetailslistViewHolder(
